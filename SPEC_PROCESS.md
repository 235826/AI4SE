...
```bash
pytest tests/test_guardrails.py::test_blocks_dangerous_test_command tests/test_agent.py::test_context_aware_llm_changes_action_after_failed_feedback tests/test_tools.py::test_interactive_approval_callback_rejection_blocks_action -q
make test
```
